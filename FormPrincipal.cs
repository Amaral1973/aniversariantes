    ...
    public partial class FormPrincipal : Form
    {
        ...
        private void btnInserir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    funcionario.Inserir(txtNome.Text, turno, mskDataNascimento.Text, txtMatricula.Text);
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtId.Text == "")
                {
                    MessageBox.Show("Por favor, digite um ID para realizar a exclusão do funcionário!");
                }
                int Id = Convert.ToInt32(txtId.Text.Trim());
                if (funcionario.ExisteId(Id) == false)
                {
        ...
        {
            FormAniversariantes aniversariantes = new FormAniversariantes();
